 ...
 */
class QuickTimeSoundDirectory : QuickTimeDirectory() {
  companion object {
    // Sound Sample Description Atom
    const val TAG_AUDIO_FORMAT = 0x0301
    const val TAG_NUMBER_OF_CHANNELS = 0x0302
    const val TAG_AUDIO_SAMPLE_SIZE = 0x0303
    const val TAG_AUDIO_SAMPLE_RATE = 0x0304
    const val TAG_SOUND_BALANCE = 0x0305
  ...
  init {
    setDescriptor(QuickTimeSoundDescriptor(this))
  }
}
