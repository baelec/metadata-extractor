...
object Mp4Dictionary {
  ...
  init {
    dictionary[Mp4Directory.TAG_MAJOR_BRAND] = majorBrands
    dictionary[Mp4VideoDirectory.TAG_COMPRESSION_TYPE] = videoCompressionTypes
    dictionary[Mp4SoundDirectory.TAG_AUDIO_FORMAT] = soundAudioFormats
    dictionary[Mp4VideoDirectory.TAG_VENDOR] = vendorIds
