...
class Mp4TextHandler(metadata: Metadata, context: Mp4Context) : Mp4MediaHandler<Mp4TextDirectory>(metadata, context) {
  override val directory: Mp4TextDirectory
    get() = Mp4TextDirectory()

  override val mediaInformation: String
    get() = Mp4ContainerTypes.BOX_MEDIA_TEXT
