...
class PsdHeaderDirectory : Directory() {
  ...
  companion object {
     ...
     */
    const val TAG_BITS_PER_CHANNEL = 4
    /**
     * The color mode of the file. Supported values are:
     * Bitmap = 0; Grayscale = 1; Indexed = 2; RGB = 3; CMYK = 4; Multichannel = 7; Duotone = 8; Lab = 9.
     */
    const val TAG_COLOR_MODE = 5
    protected val tagNameMap = HashMap<Int, String>()

    init {
      tagNameMap[TAG_CHANNEL_COUNT] = "Channel Count"
  ...
  init {
    setDescriptor(PsdHeaderDescriptor(this))
  }
}
