...
public class JpegSegmentReaderTest
{
    ...
    {
        JpegSegmentData segmentData = JpegSegmentReader.readSegments(new File("src/test/resources/withExifAndIptc.jpg"), null);

        assertEquals(1, segmentData.getSegmentCount(JpegSegmentType.APP0));
        assertArrayEquals(
                FileUtil.readBytes("src/test/resources/withExifAndIptc.jpg.app0"),
        ...
        assertArrayEquals(
                FileUtil.readBytes("src/test/resources/withExifAndIptc.jpg.app1.0"),
                segmentData.getSegment(JpegSegmentType.APP1, 0));
        assertArrayEquals(
                FileUtil.readBytes("src/test/resources/withExifAndIptc.jpg.app1.1"),
        ...
        assertArrayEquals(
                FileUtil.readBytes("src/test/resources/withExifAndIptc.jpg.app2"),
        ...
        assertArrayEquals(
                FileUtil.readBytes("src/test/resources/withExifAndIptc.jpg.appd"),
        ...
        assertArrayEquals(
                FileUtil.readBytes("src/test/resources/withExifAndIptc.jpg.appe"),
    ...
    public void testReadSpecificSegments() throws Exception
    {
        JpegSegmentData segmentData = JpegSegmentReader.readSegments(
                new File("src/test/resources/withExifAndIptc.jpg"),
    ...
    {
        JpegSegmentData segmentData = JpegSegmentReader.readSegments(new File("src/test/resources/noExif.jpg"), null);
