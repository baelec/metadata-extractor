...
public class JpegMetadataReaderTest
{
    ...
    {
        validate(JpegMetadataReader.readMetadata(new File("src/test/resources/withExif.jpg")));
    }

    @Test
    public void testExtractMetadataUsingInputStream() throws Exception
    {
        FileInputStream stream = new FileInputStream((new File("src/test/resources/withExif.jpg")));
    ...
    {
        Metadata metadata = JpegMetadataReader.readMetadata(new File("src/test/resources/withXmp.jpg"));
    ...
    {
        Metadata metadata = JpegMetadataReader.readMetadata(new File("src/test/resources/withTypicalHuffman.jpg"));
