...
public class JpegReaderTest
{
    ...
    {
        _directory = processBytes("src/test/resources/simple.jpg.sof0");
    }
...
/*
    ...
    public void testJpegWithAudio() throws Exception
    {
        ...
        File jpegFile = new File("src/test/resources/com/drew/metadata/jpeg/audioPresent.jpg");
...
//        System.out.println(jpegSegmentReader.readSegment(JpegSegmentReader.SOI));
        ...
        File audioFile = new File("src/test/resources/com/drew/metadata/jpeg/audio.wav");
