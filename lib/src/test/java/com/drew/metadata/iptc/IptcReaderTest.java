...
public class IptcReaderTest
{
    ...
    {
        IptcDirectory directory = processBytes("src/test/resources/iptc1.jpg.appd");
    ...
    {
        IptcDirectory directory = processBytes("src/test/resources/iptc2-photoshop6.jpg.appd");
    ...
    {
        IptcDirectory directory = processBytes("src/test/resources/iptc-encoding-defined-utf8.bytes");
    ...
    {
        IptcDirectory directory = processBytes("src/test/resources/iptc-encoding-undefined-iso.bytes");
    ...
    {
        IptcDirectory directory = processBytes("src/test/resources/iptc-encoding-unknown.bytes");
    ...
    public void testIptcEncodingUnknown2() throws Exception
    {
        ...
        IptcDirectory directory = processBytes("src/test/resources/iptc-encoding-unknown-2.bytes");
