...
public class ExifReaderTest
{
    ...
    {
        ExifSubIFDDirectory directory = ExifReaderTest.processBytes("src/test/resources/withExif.jpg.app1", ExifSubIFDDirectory.class);
...
//      assertEquals("F9", directory.getDescription(ExifSubIFDDirectory.TAG_APERTURE));
    ...
    public void testCrashRegressionTest() throws Exception
    {
        ...
        ExifSubIFDDirectory directory = ExifReaderTest.processBytes("src/test/resources/crash01.jpg.app1", ExifSubIFDDirectory.class);
    ...
    {
        ExifIFD0Directory directory = ExifReaderTest.processBytes("src/test/resources/manuallyAddedThumbnail.jpg.app1", ExifIFD0Directory.class);
    ...
    {
        ExifThumbnailDirectory directory = ExifReaderTest.processBytes("src/test/resources/manuallyAddedThumbnail.jpg.app1", ExifThumbnailDirectory.class);
    ...
    public void testStackOverflowOnRevisitationOfSameDirectory() throws Exception
    {
        ...
        Metadata metadata = processBytes("src/test/resources/recursiveDirectories.jpg.app1");
    ...
    public void testDifferenceImageAndThumbnailOrientations() throws Exception
    {
        ...
        Metadata metadata = processBytes("src/test/resources/repeatedOrientationTagWithDifferentValues.jpg.app1");
