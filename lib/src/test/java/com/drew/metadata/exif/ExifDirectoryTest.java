...
public class ExifDirectoryTest
{
    ...
    {
        Metadata metadata = ExifReaderTest.processBytes("src/test/resources/nikonMakernoteType2a.jpg.app1");
    ...
    {
        Metadata metadata = ExifReaderTest.processBytes("src/test/resources/withUncompressedRGBThumbnail.jpg.app1");
    ...
    {
        Metadata metadata = ExifReaderTest.processBytes("src/test/resources/withExifAndIptc.jpg.app1.0");
    ...
    {
        Metadata metadata = ExifReaderTest.processBytes("src/test/resources/withPanasonicFaces.jpg.app1");
