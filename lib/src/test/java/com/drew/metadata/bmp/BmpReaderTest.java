...
public class BmpReaderTest
{
    ...
    {
        BmpHeaderDirectory directory = processBytes("src/test/resources/16color-10x10.bmp");
    ...
    {
        BmpHeaderDirectory directory = processBytes("src/test/resources/24bpp-10x10.bmp");
