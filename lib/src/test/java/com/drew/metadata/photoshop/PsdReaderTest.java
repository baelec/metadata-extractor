...
public class PsdReaderTest
{
    ...
    {
        PsdHeaderDirectory directory = processBytes("src/test/resources/8x4x8bit-Grayscale.psd");
    ...
    {
        PsdHeaderDirectory directory = processBytes("src/test/resources/10x12x16bit-CMYK.psd");
