...
public class GifReaderTest
{
    ...
    {
        GifHeaderDirectory directory = processBytes("src/test/resources/mspaint-10x10.gif");
    ...
    {
        GifHeaderDirectory directory = processBytes("src/test/resources/photoshop-8x12-32colors-alpha.gif");
